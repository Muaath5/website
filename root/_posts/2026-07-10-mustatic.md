---
title: "MuStatic: a static website architecture for serverless settings"
...
You can use this [Github template](https://github.com/Muaath5/MuStatic) which is a basic website for poem lines in Arabic using (JSON + Python + Jekyll).
